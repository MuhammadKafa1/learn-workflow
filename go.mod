...
require (
	...
	github.com/ingka-group-digital/spectre-go-logging v1.1.0
...
require (
	...
	github.com/ingka-group-digital/spectre-go-environment/v2 v2.0.2
	github.com/ingka-group-digital/spectre-go-tracing/v3 v3.0.2
